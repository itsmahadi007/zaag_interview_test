...
class SubSample(models.Model):
    ...
    root_sample = models.ForeignKey(
        RootSample, on_delete=models.CASCADE, related_name="sub_samples"
    )
...
class Results(models.Model):
    sub_sample = models.ForeignKey(
        SubSample, on_delete=models.CASCADE, related_name="results"
    )
    name = models.CharField(max_length=255)
...
class DataModel(models.Model):
    ...
    unique_matches = models.FloatField(
        null=True, blank=True
    )  # '% Unique Matches' renamed
    ...
    total_matches = models.FloatField(
        null=True, blank=True
    )  # '% Total Matches' renamed
